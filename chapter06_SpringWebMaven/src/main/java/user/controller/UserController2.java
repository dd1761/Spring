...
public class UserController2 {
	...
	//파일 업로드
		...
		public String upload(@RequestParam MultipartFile img, HttpSession session){
			...
			/*
			실제 폴더
			C:\Spring\workspace\Spring\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\chapter06_SpringWebMaven\WEB-INF\storage

			가상폴더
			C:\Spring\workspace\Spring\chapter06_SpringWebMaven\src\main\webapp\WEB-INF\storage
			*/
